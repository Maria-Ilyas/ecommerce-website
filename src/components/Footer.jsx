...
const Footer = () => {
  return (
    <div style={bannerData} className='text-white mb-0'>
        <div className='container'>
           <div data-aos="zoom-in" className='grid md:grid-cols-3 pb-44 pt-5'>
              <div className='py-8 px-4'>
                   <h1 className='sm:text-3xl text-xl font-bold sm:text-left text-justify mb-3 flex items-center gap-3'>
                        <img src={Logo} className='max-w-[50px]' />Shopify</h1>
                   <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Laborum suscipit vitae qui ratione voluptate. Laboriosam!</p>
              </div>
